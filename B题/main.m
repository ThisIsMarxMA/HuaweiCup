...
%主函数部分
dataNo313=Q1_step3(dataNo313);  %按3sigma法则，异常值置零
dataNo313=Q1_step1(dataNo313,0.7);  %按40*0.7执行第一点
Vec_dataNo313=mean(dataNo313);  %附件三平均值

dataNo285=Q1_step3(dataNo285);  %按3sigma法则，异常值置零
...
%对附件一处理
data_354=Q1_step2(data_354,range);  %按变量范围置0
data_354=Q1_step1(data_354,1);      %列中有一个0则整列置0
